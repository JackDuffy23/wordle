...
public class wordle {
	...
	public static void wordle(String a) throws IOException {
		...
		// Read File Line By Line, add words to list
		...
		for (int i = 0; i < currentGuess.length(); i++) {
			...
			if (answer.contains(Character.toString(currentGuess.charAt(i)))) { // if hidden word contains the letter
				...
				else if (!containsLetters.contains(x)) // if it contains the letter but not in correct position
